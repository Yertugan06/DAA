...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("--- Correctness Test for ClosestPairOfPoints2D ---");
        Point[] points = {
                new Point(2, 3), new Point(12, 30), new Point(40, 50),
                new Point(5, 1), new Point(12, 10), new Point(3, 4)
        };

        ClosestPairResult res = ClosestPairOfPoint2D.closestPair(points);
        System.out.println("The closest distance is " + res.dist);
        System.out.println("Between points (" + res.p1.x + ", " + res.p1.y +
                ") and (" + res.p2.x + ", " + res.p2.y + ")");
        System.out.println();
    }
}
